...
heart = pickle.load(open('deploy/heart(logistic).sav', 'rb'))
parkinson = pickle.load(open('deploy/parkinson(svm).sav', 'rb'))
diabetes = pickle.load(open('deploy/diabetes_logistic.sav', 'rb'))
